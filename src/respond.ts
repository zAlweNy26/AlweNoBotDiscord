import { type APIEmbed, type APIInteractionResponse, InteractionResponseType, MessageFlags } from "discord.js"
...
export function messageResponse(
  data: NonNullable<
    Extract<APIInteractionResponse, { type: InteractionResponseType.ChannelMessageWithSource }>["data"]
  >,
) {
  return {
